...
The slug is set on the page in Ghost; the template name is what you pick in the page’s template dropdown. Theme settings (`@custom.*`) control copy and toggles; see [Theme settings](./theme-settings).
